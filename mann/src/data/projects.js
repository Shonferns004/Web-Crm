...
export const homeProjects = [
  {
    slug: "poshan", num: "01", color: "#f9a8d4", icon: "restaurant",
  ...
  {
    slug: "gyaan", num: "02", color: "#fda4af", icon: "school",
  ...
  {
    slug: "sakhi", num: "03", color: "#f472b6", icon: "female",
  ...
  {
    slug: "swasth", num: "04", color: "#fb7185", icon: "medical_services",
  ...
  {
    slug: "pashu", num: "05", color: "#f9a8d4", icon: "pets",
  ...
  {
    slug: "paryavaran", num: "06", color: "#22c55e", icon: "eco",

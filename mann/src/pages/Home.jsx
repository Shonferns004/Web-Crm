...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* ===== ABOUT DETAILED ===== */}
      <section className="py-section-padding-mobile md:py-section-padding-desktop bg-surface-container-high" id="about-us">
        <div className="max-w-container-max mx-auto px-8">
      ...
      {/* ===== INITIATIVES ===== */}
      <section className="py-section-padding-mobile md:py-section-padding-desktop bg-white" id="projects">
      ...
      {/* ===== GET INVOLVED ===== */}
      <section className="py-section-padding-mobile md:py-section-padding-desktop bg-white" id="get-involved-new">
        <div className="max-w-container-max mx-auto px-8">
      ...
      {/* ===== CAUSES TO SUPPORT ===== */}
      <section className="py-section-padding-mobile md:py-section-padding-desktop bg-surface-container-low" id="causes-support">
        <div className="max-w-container-max mx-auto px-8">
          <div className="mb-20">
            <Reveal>
      ...
      {/* ===== PARTNERS ===== */}
      <section
        className="py-24 md:py-32 bg-white overflow-hidden marquee-container"
        id="our-partners"
      >
        <div className="max-w-container-max mx-auto px-8 mb-16">
          <Reveal>
            <div className="flex flex-col md:flex-row items-baseline justify-between gap-10">
      ...
      {/* ===== YOUR TURN TO LEAD ===== */}
      <section className="py-section-padding-mobile md:py-section-padding-desktop bg-surface-container-high" id="your-turn-to-lead">
        <div className="max-w-container-max mx-auto px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
      ...
      {/* ===== CONTACT ===== */}
      <section className="py-section-padding-mobile md:py-section-padding-desktop bg-white" id="contact">
        <div className="max-w-container-max mx-auto px-8">

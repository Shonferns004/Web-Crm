// Floating WhatsApp button – soft modern (bottom-right, green)
export default function WhatsAppButton() {
  return (
    <a
      ...
      rel="noreferrer"
      aria-label="WhatsApp"
      className="fixed bottom-8 right-8 w-16 h-16 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-all z-50"
    >
